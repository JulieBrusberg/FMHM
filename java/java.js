...
if (a5 == "a") {
    ...
    document.getElementById("a5").style.backgroundColor = "#9B3A3A";
}
/*Kode til b*/
...
if (b1 == "b") {
    ...
    document.getElementById("b1").style.backgroundColor = "#9B3A3A";
}
/*Kode til d*/
...
if (d1 == "d") {
    ...
    document.getElementById("d1").style.backgroundColor = "#9B3A3A";
}
/*Kode til e*/
...
if (e3 == "e") {
    ...
    document.getElementById("e3").style.backgroundColor = "#9B3A3A";
}
/*Kode til f*/
...
if (f2 == "f") {
    ...
    document.getElementById("f2").style.backgroundColor = "#9B3A3A";
}
/*Kode til g*/
...
if (g2 == "g") {
    ...
    document.getElementById("g2").style.backgroundColor = "#9B3A3A";
}
/*Kode til i*/
...
if (i == "i") {
    ...
    document.getElementById("i3").style.backgroundColor = "#9B3A3A";
}
/*Kode til k*/
...
if (k1 == "k1") {
    ...
    document.getElementById("k1").style.backgroundColor = "#9B3A3A";
}
/*Kode til l*/
...
if (l1 == "l") {
    ...
    document.getElementById("l1").style.backgroundColor = "#9B3A3A";
}
/*Kode til m*/
...
if (m1 == "m") {
    ...
    document.getElementById("m1").style.backgroundColor = "#9B3A3A";
}
/*Kode til n*/
...
if (n == "n4") {
    ...
    document.getElementById("n4").style.backgroundColor = "#9B3A3A";
}
/*Kode til o*/
...
if (o1 == "o") {
    ...
    document.getElementById("o1").style.backgroundColor = "#9B3A3A";
}
/*Kode til r*/
...
if (r3 == "r") {
    ...
    document.getElementById("r3").style.backgroundColor = "#9B3A3A";
}
/*Kode til s*/
...
if (s1 == "s") {
    ...
    document.getElementById("s1").style.backgroundColor = "#9B3A3A";
}
/*Kode til t*/
...
if (t3 == "t") {
    ...
    document.getElementById("t3").style.backgroundColor = "#9B3A3A";
}
/*Kode til v*/
...
if (v == "v") {
    ...
    document.getElementById("v").style.backgroundColor = "#9B3A3A";
}
/*Kode til y*/
...
if (y == "y") {
    ...
    document.getElementById("y").style.backgroundColor = "#9B3A3A";
}
/*Kode til æ*/
...
if (ae1 == "æ") {
    ...
    document.getElementById("ae1").style.backgroundColor = "#9B3A3A";
}
}
    /*
    opgave 2
